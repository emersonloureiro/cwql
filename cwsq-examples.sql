...
CWQL
	SELECT max(CPUUtilization), avg(CPUUtilization) FROM AWS/EC2 WHERE InstanceId='i-00c753b8c2e2273a9' BETWEEN 2018-03-10T00:00:00Z AND 2018-03-10T14:00:00Z PERIOD 10
	SELECT max(ec21.CPUUtilization), avg(ec22.CPUUtilization) FROM AWS/EC2 as ec21, FROM AWS/EC2 as ec22  WHERE ec21.InstanceId='i-00c753b8c2e2273a9' AND ec22.InstanceId='i-00c753b8c2e2273a9' BETWEEN 2018-03-10T00:00:00Z AND 2018-03-10T14:00:00Z PERIOD 10
