...
CWQL
	correct
		...
		SELECT min(CPUUtilization) as min_cpu, max(CPUUtilization) as max_cpu, avg(CPUUtilization) as avg_cpu FROM AWS/EC2 WHERE InstanceId='i-00c753b8c2e2273a9' BETWEEN 2018-03-10T00:00:00Z AND 2018-03-10T14:00:00Z PERIOD 3600
		SELECT avg(ec22.CPUUtilization), max(ec21.CPUUtilization) FROM AWS/EC2 as ec21, AWS/EC2 as ec22  WHERE ec21.InstanceId='i-00c753b8c2e2273a9' AND ec22.InstanceId='i-00c753b8c2e2273a9' BETWEEN 2018-03-10T00:00:00Z AND 2018-03-10T14:00:00Z PERIOD 3600
	...
	invalid
		...
		SELECT max(ec2.CPUUtilization) as avg_cpu, avg(ec2.DiskSpace) as avg_cpu FROM AWS/EC2 as ec2  WHERE InstanceId='i-00c753b8c2e2273a9' BETWEEN 2018-03-10T00:00:00Z AND 2018-03-10T14:00:00Z PERIOD 3600